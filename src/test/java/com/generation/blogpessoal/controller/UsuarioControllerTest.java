...
public class UsuarioControllerTest {
	...
	@BeforeAll // INDICA QUE O METODO ABAIXO É EXECUTADO ANTES DE TODOS OS METODOS
	void start() {

		usuarioRepository.deleteAll(); // QUANDO ELE RODAR PELA PRIMEIRA VEZ, ELE RESETA O BANCO PARA NÃO TER NADA

		usuarioService.cadastrarUsuario(new Usuario(0L, // E DEPOIS ELE CRIA UM USUARIO PARA FAZER AS COMPARAÇÕES DEPOIS
				"Root", "root@root.com", "rootroot", "-"));

	}

	@Test // INDICA QUE O CODIGO EXECUTARA UM TESTE
	@DisplayName("Cadastrar Um Usuário") // CONFIGURA UMA MENSAGEM QUE SERÁ EXIBIDA AO INVÉS DO NOME DO MÉTODO
	public void deveCriarUmUsuario() {

		// MONTA O CPORPO DA REQUISIÇÃO
